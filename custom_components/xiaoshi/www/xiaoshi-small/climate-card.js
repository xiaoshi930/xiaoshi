...
class XiaoshiSmallClimateCardEditor extends LitElement {
  ...
  static get styles() {
    return css`      .form { display: flex; flex-direction: column; gap: 10px; min-height: 500px; }
      ...
      .entity-dropdown { position: absolute; top: 100%; left: 0; right: 0; height: 300px; overflow-y: auto; background: white; border: 1px solid #ddd; border-radius: 4px; box-shadow: 0 0 8px rgba(0,0,0,0.25); z-index: 1000; margin-top: 2px; }
...
class XiaoshiSmallClimateCard extends LitElement {
  ...
  static get styles() { 
    return css`      :host { display: block; max-width: 500px; margin: 0 auto; }
      ...
      .temp-area { display: flex; align-items: center; justify-content: center; transition: opacity 0.3s ease, max-width 0.3s ease; overflow: visible; max-width: 200px; opacity: 1; }
      .temp-area.hidden { max-width: 0; opacity: 0; overflow: hidden; padding: 0; gap: 0; }
      .temp-card { display: flex; align-items: center; gap: 8px; background: transparent; border-radius: 20px; padding: 6px 14px; box-shadow: 0 0 8px var(--shadow-color, rgba(0,0,0,0.25)); }
      .temp-adjust-button { background: none; border: none; cursor: pointer; padding: 0; display: flex; align-items: center; justify-content: center; color: var(--temp-control-color); width: 18px; height: 18px; border-radius: 50%; cursor: default; }
      .temp-display { font-size: 15px; font-weight: bold; min-width: 30px; text-align: center; color: var(--temp-control-color, #333); }
      ...
      .mode-btn { width: 32px; height: 32px; border-radius: 50%; background: transparent; border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.2s ease; flex-shrink: 0; }
