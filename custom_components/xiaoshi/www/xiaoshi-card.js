console.info("%c 消逝卡-汇总卡 \n%c  2026.7.1.01 ", "color: red; font-weight: bold; background: black", "color: white; font-weight: bold; background: black");
...
//import('./xiaoshi-card/music-card.js');
...
import('./xiaoshi-pad/camera-card.js');
